...
def main() -> None:
    ...
    amulet_anvil_path = get_package_dir("amulet.anvil")
    tests_path = os.path.join(root_path, "tests")
    test_amulet_anvil_path = os.path.join(tests_path, "test_amulet_anvil")
    ...
    modules: list[tuple[str, str, str]] = [
        (src_path, amulet_anvil_path, "amulet.anvil"),
        (tests_path, test_amulet_anvil_path, "test_amulet_anvil"),
    ]
