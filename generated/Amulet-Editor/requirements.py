...
AMULET_PYBIND11_EXTENSIONS_REQUIREMENT = "~=1.2.0.0a1"
AMULET_IO_REQUIREMENT = "~=1.0"
AMULET_LEVELDB_REQUIREMENT = "~=3.0.4.0a2"
AMULET_UTILS_REQUIREMENT = "~=1.1.3.0a3"
AMULET_ZLIB_REQUIREMENT = "~=1.0.8.0a0"
AMULET_NBT_REQUIREMENT = "~=5.0.2.0a2"
AMULET_CORE_REQUIREMENT = "~=2.0.6.0a1"
AMULET_RESOURCE_PACK_REQUIREMENT = "~=1.0.2.0a4"
AMULET_GAME_REQUIREMENT = "~=1.0.2.0a4"
